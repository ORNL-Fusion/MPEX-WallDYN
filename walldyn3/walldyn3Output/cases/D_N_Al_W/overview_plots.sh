...
$script --valfp "./results/ProtoEmpex_Conc_100.000.dat" --valcfg 2 1 --vallabel "W-Conc 100sec." --valuerange "0 1" --trigen $trigen --idxgrp $idxgrp &
$script --valfp "./results/ProtoEmpex_Conc_0.000.dat" --valcfg 2 1 --vallabel "W-Conc 0sec." --valuerange "0 1" --trigen $trigen --idxgrp $idxgrp &
